...
router.get("/emp", employee.getEmployees);

router.get("/emp/filter/:position", employee.getEmployeesFilter)

router.post("/emp", verifyToken, employee.createEmployee);

router.get("/emp/:id", verifyToken, employee.getEmployee);

router.put("/emp/:id", verifyToken, employee.editEmployee);

router.delete("/emp/:id", verifyToken, employee.deleteEmployee);
